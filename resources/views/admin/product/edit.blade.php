            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="product" type="text" value="{{ $product->product }}" />
                    </div>
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea id="demo" class="form-control ckeditor" name="description">{{ $product->description }}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Chỉnh sửa hình ảnh</label>
                        <img width="200px" src="upload/product/{{$product->img_url}}"><br>
                        <input type="file" name="image" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label>Số lượng</label>
                        <input class="form-control" name="quality" type="number" value="{{ $product->quality }}" min="0" />
                    </div>

                    <div class="form-group">
                        <label>Đơn giá (đơn vị: nghìn VND)</label>
                        <input class="form-control" name="price" type="number" value="{{ $product->price/1000 }}" min="1" />
                    </div>
